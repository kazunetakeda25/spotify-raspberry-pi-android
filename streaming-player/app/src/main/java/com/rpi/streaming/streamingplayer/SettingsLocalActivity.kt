...
import kotlinx.android.synthetic.main.activity_settings_local.*
import java.io.File
...
class SettingsLocalActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_settings_local)
        ...
        localMusicServerRecycleView!!.addOnItemTouchListener(RecyclerTouchListener(applicationContext, localMusicServerRecycleView!!, object : RecyclerTouchListener.ClickListener {
            ...
            override fun onClick(view: View, position: Int) {
                launchChangeLocalMusicServerInfoActivity(position)
            }
        }))
    ...
    private fun launchChangeLocalMusicServerInfoActivity(position: Int) {
        val intent = Intent(this, SettingsLocalModifyActivity::class.java)
