...
import kotlinx.android.synthetic.main.activity_settings_local_modify.*

class SettingsLocalModifyActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_settings_local_modify)
...
//                var exists = false
//                this@SettingsLocalModifyActivity.run {
//                    try {
...
//                    }
//                }
//                this@SettingsLocalModifyActivity.runOnUiThread {
//                    if (!exists) {
//                        changeButton.error = "Incorrect Local Music Server Credentials!"
