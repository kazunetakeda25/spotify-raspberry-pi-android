...
package com.musicplayer.rpi.streamingspotifydemo;
...
public class MainActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSeekEditText = findViewById(R.id.seek_edittext);
        mStatusTextScrollView = findViewById(R.id.status_text_container);
    ...
    private void updateView() {
        ...
        if (mMetadata != null && mMetadata.currentTrack != null) {
            ...
            mMetadataText.setText(String.format("%s\n%s - %s%s", mMetadata.contextName, mMetadata.currentTrack.name, mMetadata.currentTrack.artistName, durationStr));
